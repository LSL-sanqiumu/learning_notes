...
多表查询，无非内连接查询、外连接查询（左外、右外、全外）、交叉连接。
...
**题目1：**手机中的相机是深受大家喜爱的应用之一，下图是某手机厂商数据库中的用户行为信息表中部分数据的截图。

<img src="img/ex_9.png" style="zoom: 67%;" />

1. 用户id：用户唯一标识。
2. 应用名称：是手机中的某个应用，例如相机、微信、大众点评等。
3. 启动时长：某一天中使用某应用多长时间（分钟）。
4. 启动次数：某一天中启动了某应用多少次。
5. 登陆时间：使用手机的日期。例如2018-05-01。

现在该手机厂商想要分析手机中的应用**（相机）**的活跃情况，需统计如下数据：某日活跃用户（用户id）在后续的一周内的留存情况（计算次日留存用户数，3日留存用户数，7日留存用户数）。
...
例如：登陆时间（20180501日）去重用户数10000，这批用户在20180503日仍有7000人活跃，则3日活跃留存率为7000/10000=70%；所需获得的结果格式如下：

<img src="img/ex_10.png" style="zoom: 80%;" />
...
(1,'相机',1,2,'2018-05-01'),(1,'相机',1,2,'2018-05-02'),(1,'相机',1,2,'2018-05-03'),
(1,'相机',1,2,'2018-05-04'),(1,'相机',1,2,'2018-05-05'),(1,'相机',1,2,'2018-05-06'),
(1,'相机',1,2,'2018-05-07'),(1,'相机',1,2,'2018-05-08'),(1,'相机',1,2,'2018-05-09'),
(1,'相机',1,2,'2018-05-10'),(2,'相机',1,2,'2018-05-01'),(2,'相机',1,2,'2018-05-02'),
(2,'相机',1,2,'2018-05-03'),(2,'相机',1,2,'2018-05-04'),(3,'相机',1,2,'2018-05-01'),
(4,'相机',1,2,'2018-05-01'),(5,'相机',1,2,'2018-05-02'),(6,'相机',1,2,'2018-05-03'),
(6,'相机',1,2,'2018-05-04'),(7,'相机',1,2,'2018-05-04'),(7,'相机',1,2,'2018-05-05'),
(7,'相机',1,2,'2018-05-06'),(8,'相机',1,2,'2018-05-04'),(9,'相机',1,2,'2018-05-04'),
(10,'相机',1,2,'2018-05-05'),(11,'相机',1,2,'2018-05-05'),(12,'相机',1,2,'2018-05-06'),
(13,'相机',1,2,'2018-05-10'),(14,'相机',1,2,'2018-05-10'),(15,'相机',1,2,'2018-05-10'),
(13,'相机',1,2,'2018-05-7'),(14,'相机',1,2,'2018-05-8'),(15,'相机',1,2,'2018-05-9'),
(10,'微信',1,1,'2018-05-01');
```
...
```mysql
select logintime,count(distinct id) as 活跃用户数 from userinfo where appname='相机' group by logintime;
+------------+------------+
| logintime  | 活跃用户数 |
+------------+------------+
| 2018-05-01 |          4 |
